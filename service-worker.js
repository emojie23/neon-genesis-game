const CACHE='neon-genesis-v18-animated-sprite-growth';
const FILES=['./','./index.html','./styles.css','./game.js','./manifest.webmanifest','./assets/sprites/protagonist-atlas-v2.png','./assets/sprites/boss-atlas-v2.png','./assets/sprites/enemy-atlas-v2.png'];
